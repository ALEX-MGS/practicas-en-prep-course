...
while(continuar):
    ...
    print('* 1a:', lista_respuestas[20])
    print('* 1b:', lista_respuestas[4.0])
    print('* 1c:', lista_respuestas[32])
    print('* 1d:', lista_respuestas[0.6])
    print('* 1e:', lista_respuestas[2.0])
    print('* 2a:', lista_respuestas[3.0])
    print('* 2b:', lista_respuestas[15])
    print('* 3a:', lista_respuestas[TRUE])
    print('* 3b:', lista_respuestas[FALSE])
    print('* 3c:', lista_respuestas[FALSE])
    print('* 3d:', lista_respuestas[FALSE])
